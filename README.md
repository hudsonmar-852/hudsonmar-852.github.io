...
- `/aios/work-items/` — governed Work Items dashboard
...
```sh
node --test aios/tests/production-consolidation.test.mjs aios/tests/job-match.test.mjs aios/tests/secret-scan.test.mjs aios/tests/work-items.test.mjs aios/tests/work-items-page.test.mjs avataros/tests/prompt-builder.test.mjs avataros/tests/validation.test.mjs functions/private-test/index.test.mjs
