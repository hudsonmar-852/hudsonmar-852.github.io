...
```sh
node --test aios/tests/production-consolidation.test.mjs aios/tests/job-match.test.mjs avataros/tests/prompt-builder.test.mjs avataros/tests/validation.test.mjs functions/private-test/index.test.mjs
