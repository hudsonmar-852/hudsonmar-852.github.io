...
Main-branch scope notice: this draft records reviewed product evidence.
References to the Work Items or Google Drive read-only prototype do not mean
those implementations are active; both remain paused and excluded from this
main-branch change.
