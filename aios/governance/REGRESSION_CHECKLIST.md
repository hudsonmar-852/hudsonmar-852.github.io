...
Main-branch scope notice: Work Items and Google Drive checks below are retained
for future use against the paused prototype. Their presence does not indicate
that either implementation is included or deployed.
